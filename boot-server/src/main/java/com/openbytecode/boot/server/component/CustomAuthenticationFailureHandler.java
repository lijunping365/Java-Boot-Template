...
/**
 * <p>
 *   自定义用户登录失败处理逻辑，实现了 {@link AuthenticationFailureHandler}
 *   更多文档请参考
...
public class CustomAuthenticationFailureHandler implements AuthenticationFailureHandler {
    ...
    public CustomAuthenticationFailureHandler(Ip2regionSearcher ip2regionSearcher,
    ...
    public <T extends BaseLoginRequest> void onAuthenticationFailureHandler(AuthenticationException authenticationException, T request) {
        ...
        loginLogDO.setStatus(CommonStatusEnum.NO.getValue());
        loginLogDO.setError(authenticationException.getMessage());
